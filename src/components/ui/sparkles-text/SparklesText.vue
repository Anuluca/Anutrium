...
@keyframes sparkle-pulse-rotate {
  0% {
    opacity: 0;
...
.sparkles-text__sparkle {
  ...
  animation: sparkle-pulse 0.8s ease-in-out var(--sparkle-delay) infinite;
}

.sparkles-text__sparkle--rotating {
  animation-name: sparkle-pulse-rotate;
}
</style>
