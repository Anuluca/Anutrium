export default {
      ...
      recommend: [
        {
          id: 1,
          title: 'ANUTRIUM 正式上线',
          subtitle: '个人网站第三次迭代 — 使用 Vue 3 从零重构。',
          category: 'RELEASE',
          date: '2026.06.10',
  ...
  flanerie: {
    ...
    pageLabel: '页',
    dynamic: {
      // 旅程地图坐标规则：国内城市统一使用所在省份省会坐标；中国以外的国家/地区使用官方定义的首都坐标。
      groups: [
        {
          id: 'visited',
          title: '旅行目的地',
  ...
  about: {
    ...
    brandColorTitleLead: '秩序与生命力。',
    brandColorName: '热情红',
    changelogLabel: '更新日志',
    majorOnlyLabel: '只看重大更新',
    majorUpdateLabel: '重大更新',
    latestLabel: 'LATEST',
    dynamic: {
      changelogs: [
        {
