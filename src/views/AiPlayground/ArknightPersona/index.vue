  ...
  >
    ...
    >
      <div class="frame-caption">
        <span><i /> INTERFACE STUDY <b>01</b></span>
        <span>ARKNIGHTS <em>×</em> PERSONA 3 RELOAD</span>
      </div>
      <div
        ref="viewport"
        ...
        >
          ...
          >
            ...
            <div class="petals" aria-hidden="true">
              <i v-for="petal in petals" :key="petal.id" :style="petal.style" />
            </div>
            ...
            >
              ...
              >
              <span class="level">120</span><span class="level-label">LV</span>
              <strong>羊角</strong><small>ID: 744586145</small>
            </button>
            ...
            <nav class="game-menu" aria-label="游戏主菜单">
              <div class="terminal-wrap entrance" style="--delay: 360ms">
                ...
                >
                  ...
                  <span class="terminal-word" aria-hidden="true">TERMINAL</span>
            ...
            <span class="online-count"><UiIcon name="users" />70 人正在看</span>
      ...
      <div class="frame-controls">
        <span class="interaction-hint"><i /> 鼠标探索 · 点击菜单交互</span>
        <div>
          <button
            type="button"
            ...
            @click="toggleMotion"
          >
            {{ motionEnabled ? '视差 开' : '视差 关' }}
          </button>
          <button type="button" @click="replayEntrance">
            重播入场 <span>↻</span>
          </button>
          <button
...
import classroom from '@/assets/img/ai-playground/arknight-persona/classroom.webp'
import protagonist from '@/assets/img/ai-playground/arknight-persona/protagonist.webp'
...
const resizeScene = () => {
  ...
  scale.value =
    Math.max(expanded.value ? 1000 : 0, viewport.value.clientWidth) / 1600
}
...
watch(expanded, () => nextTick(resizeScene))
onMounted(() => {
